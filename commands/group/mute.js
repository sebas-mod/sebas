...
module.exports = {
    ...
    code: async (ctx) => {
        ...
        if (ctx.args[0] === "bot") {
            ...
            return await ctx.reply(quote("✅ ¡Este grupo se ha silenciado con éxito de la bot!"));
        }
        ...
        try {
            ...
            return await ctx.reply(quote("✅ ¡El usuario de este grupo fue silenciado exitosamente!"));
        } catch (error) {
